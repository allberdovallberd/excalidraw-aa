  ...
  return {
    ...
    plugins: [
      ...
      VitePWA({
        ...
        manifest: {
          short_name: "Akylly Tagta",
          name: "Akylly Tagta",
          description:
            "Akylly Tagta is a collaborative drawing tool that lets you easily sketch diagrams with a hand-drawn feel.",
          icons: [
            {
          ...
          file_handlers: [
            {
              action: "/",
              accept: {
                "application/vnd.excalidraw+json": [".akyllytagta"],
              },
            },
          ],
          share_target: {
